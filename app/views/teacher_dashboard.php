...
<body id="page-top">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- Nav Item - Current Time -->
                        <li class="nav-item no-arrow mx-2 d-flex align-items-center">
                            <span id="currentTime" class="text-gray-600 small"></span>
                        </li>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Sarah McKay</span>
                                <img class="img-profile rounded-circle"
                                    src="assets/images/undraw_profile_3.svg" alt="Profile">
                            </a>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">Term 2</div>
                                            </div>
                                            <div class="col-auto">
                                    ...
                                    <div class="card-body" style="max-height: 270px; overflow-y: auto;">
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item d-flex justify-content-between align-items-center hover-shadow">
                                                <div>
                                                    <strong>School Closed:</strong> No classes on Jan 15 due to public holiday.
                                                    <div class="text-muted"><span>Jan 10, 2026</span></div>
                                                </div>
                                                
                                            </li>
                                            <li class="list-group-item d-flex justify-content-between align-items-center hover-shadow">
                                                <div>
                                                    <strong>Parent-Teacher Meeting:</strong> Scheduled for Feb 5, 2026.
                                                    <div class="text-muted"><span>Jan 8, 2026</span></div>
                                                </div>
                                                
                                            </li>
                                            <li class="list-group-item d-flex justify-content-between align-items-center hover-shadow">
                                                <div>
                                                    <strong>Exam Schedule Released:</strong> Check your student portal for details.
                                                    <div class="text-muted"><span>Jan 5, 2026</span></div>
                                                </div>
                                                
                                            </li>
                                            <li class="list-group-item d-flex justify-content-between align-items-center hover-shadow">
                                                <div>
                                                    <strong>Sports Day:</strong> April 12, 2026, at the school field.
                                                    <div class="text-muted"><span>Jan 2, 2026</span></div>
                                                </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; CSE3101 - School Management System 2026</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="assets/js/academic_perf.js"></script>
