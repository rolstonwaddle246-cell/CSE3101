...
class Grade extends Model
{
    ...
    public function create($grade_name, $level_order = 0)
    {
        ...
        $stmt = $this->db->prepare("
            INSERT INTO grades (grade_name, level_order) 
            VALUES (:grade_name, :level_order)
        ");
    ...
    {
        $stmt = $this->db->prepare("DELETE FROM grades WHERE grade_id = :id");
